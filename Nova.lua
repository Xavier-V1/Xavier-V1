...
return {
Lock     = '[‹ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐍𝐨𝐯𝐚 ›](https://t.me/Nova)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n◍ خاصيه المسح *',
unLock   = '[‹ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐍𝐨𝐯𝐚 ›](https://t.me/Nova)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[‹ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐍𝐨𝐯𝐚 ›](https://t.me/Nova)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n◍ خاصيه الكتم *',
lockKid  = '[‹ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐍𝐨𝐯𝐚 ›](https://t.me/Nova)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n◍ خاصيه التقييد *',
lockKick = '[‹ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐍𝐨𝐯𝐚 ›](https://t.me/Nova)\n*— — — — — — — — —\n◍ بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n◍ خاصيه الطرد *',
Reply    = '[‹ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐍𝐨𝐯𝐚 ›](https://t.me/Nova)\n*— — — — — — — — —\n◍ المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
if tonumber(msg.sender.user_id) == 1918870568 then
...
{
{text = Grosupsw, url = 'https://t.me/TmNova'}, 
},
{
{text = Usperos, url = 'https://t.me/TmNova'}, 
},
}
...
data = {
{
{text = '‹ قناه السورس ›', url = 't.me/TmNova'}, 
},
}
}
...
if text == 'محمد' or text == 'هارلين' then
photo = "https://t.me/u_g_t/2"
local T =[[
 𝒑𝒓𝒐𝒈𝒓𝒂𝒎𝒎𝒆𝒓 𝒉𝒂𝒓𝒍𝒊𝒏
   𝒕𝒐 𝒄𝒐𝒎𝒎𝒖𝒏𝒊𝒄𝒂𝒕𝒆 𝒕𝒐𝒈𝒆𝒕𝒉𝒆𝒓
      𝒇𝒐𝒍𝒍𝒐𝒘 𝒕𝒉𝒆 𝒑𝒖𝒕𝒕𝒐𝒏𝒔 𝒍𝒐𝒘𝒆𝒓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '‹ 𝒉𝒂𝒓𝒍𝒊𝒏 ›', url = "https://t.me/G_W_P"}
},
{
...
photo = "https://t.me/dv_harlin/399"
local T =[[
*𝐰𝐞𝐥𝐜𝐨𝐦 𝐨𝐭 𝐬𝐨𝐮𝐫𝐜𝐞 𝐧𝐨𝐯𝐚*
*𝐭𝐡𝐞 𝐛𝐞𝐬𝐭 𝐬𝐨𝐮𝐫𝐜𝐞 𝐨𝐧 𝐭𝐞𝐭𝐥𝐞𝐠𝐫𝐚𝐦*
*𝐧𝐨𝐯𝐚 𝐢𝐧 𝐛𝐨𝐮𝐭𝐭𝐨𝐧𝐬 𝐛𝐞𝐥𝐨𝐥*
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '‹ 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫 ›', url = "https://t.me/E_J_W"},{text = '‹ 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫 ›', url = "https://t.me/G_W_P"}
},
{
{text = '‹ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐍𝐨𝐯𝐚 ›', url = "https://t.me/TmNova"}
},
...
{
{text = '‹ قناه السورس ›', url = 't.me/Nova'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,'◍ عليك استخدام اوامر التحكم بالقوائم',"md",false, false, false, false, reply_markup)
...
local NamesBot = (Redis:get(TheNova.."Nova:Name:Bot") or "نوفا")
local BotName = {
...
keyboard.inline_keyboard = {
{
{text = ' '..mrt.first_name..' ', url = 'https://t.me/'..UserBot}, 
},
{
{text = '‹ اضافه البوت لمجموعتك ›', url = 't.me/'..UserBot..'?startgroup=new'},
},
}
msgg = msg.id/2097152/0.5
...
if text == (Redis:get(TheNova.."Nova:Name:Bot") or "نوفا") then
local photo = LuaTele.getUserProfilePhotos(TheNova)
local mrt = LuaTele.getUser(TheNova)
for Name_User in string.gmatch(mrt.first_name, "[^%s]+" ) do
mrt.first_name = Name_User
...
local CmdStart = '*\n◍ أهلآ بك في بوت '..(Redis:get(TheNova.."Nova:Name:Bot") or "نوفا")..
...
data = {
{
{text = '‹ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐍𝐨𝐯𝐚 ›', url = 't.me/TmNova'}, 
},
}
}
local TextHelp = [[*
